...
class QuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(Content.USER_NAME)
        ...
        mQuestionsList = Content.getQuestions()
        setQuestion()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            intent.putExtra(Content.USER_NAME, mUserName)
                            intent.putExtra(Content.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(Content.TOTAL_QUESTIONS, mQuestionsList?.size)
